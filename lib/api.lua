--[[pod_format="raw",created="2024-03-24 14:56:58",modified="2024-06-27 14:24:57",revision=1]]
...
function _cp(f0, f1, moving, nodata)
...
function cp(src, dest, nodata)
	_cp(src, dest, false, nodata) -- don't expose the moving parameter; is an internal detail
end
